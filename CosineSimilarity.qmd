...
- If the vectors are in the same direction roughly, their cosine similarity is near +1.
- If the vectors close to perpendicular, their cosine similarity is near 0.
- If the vectors are in the oppsite direction their cosine similarity is near -1.
